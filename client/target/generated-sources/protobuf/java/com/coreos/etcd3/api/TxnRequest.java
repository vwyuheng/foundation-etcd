...
public  final class TxnRequest extends
        ...
        switch (tag) {
          ...
          case 10: {
            if (!((mutable_bitField0_ & 0x00000001) == 0x00000001)) {
              compare_ = new java.util.ArrayList<com.coreos.etcd3.api.Compare>();
              mutable_bitField0_ |= 0x00000001;
            }
            compare_.add(
                input.readMessage(com.coreos.etcd3.api.Compare.parser(), extensionRegistry));
            break;
          }
          case 18: {
            if (!((mutable_bitField0_ & 0x00000002) == 0x00000002)) {
              success_ = new java.util.ArrayList<com.coreos.etcd3.api.RequestOp>();
              mutable_bitField0_ |= 0x00000002;
            }
            success_.add(
                input.readMessage(com.coreos.etcd3.api.RequestOp.parser(), extensionRegistry));
            break;
          }
          case 26: {
            if (!((mutable_bitField0_ & 0x00000004) == 0x00000004)) {
              failure_ = new java.util.ArrayList<com.coreos.etcd3.api.RequestOp>();
  ...
  public static final com.google.protobuf.Descriptors.Descriptor
      getDescriptor() {
    return com.coreos.etcd3.api.Rpc.internal_static_etcdserverpb_TxnRequest_descriptor;
  }

  protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
      internalGetFieldAccessorTable() {
    return com.coreos.etcd3.api.Rpc.internal_static_etcdserverpb_TxnRequest_fieldAccessorTable
        .ensureFieldAccessorsInitialized(
            com.coreos.etcd3.api.TxnRequest.class, com.coreos.etcd3.api.TxnRequest.Builder.class);
  }

  public static final int COMPARE_FIELD_NUMBER = 1;
  private java.util.List<com.coreos.etcd3.api.Compare> compare_;
  /**
   * <pre>
   ...
   */
  public java.util.List<com.coreos.etcd3.api.Compare> getCompareList() {
    return compare_;
  }
  /**
   * <pre>
   ...
   * <code>repeated .etcdserverpb.Compare compare = 1;</code>
   */
  public java.util.List<? extends com.coreos.etcd3.api.CompareOrBuilder> 
   ...
   * <code>repeated .etcdserverpb.Compare compare = 1;</code>
   */
  public com.coreos.etcd3.api.Compare getCompare(int index) {
   ...
   * <code>repeated .etcdserverpb.Compare compare = 1;</code>
   */
  public com.coreos.etcd3.api.CompareOrBuilder getCompareOrBuilder(
      int index) {
    return compare_.get(index);
  }

  public static final int SUCCESS_FIELD_NUMBER = 2;
  private java.util.List<com.coreos.etcd3.api.RequestOp> success_;
  /**
   * <pre>
   ...
   */
  public java.util.List<com.coreos.etcd3.api.RequestOp> getSuccessList() {
    return success_;
  }
  /**
   * <pre>
   ...
   * <code>repeated .etcdserverpb.RequestOp success = 2;</code>
   */
  public java.util.List<? extends com.coreos.etcd3.api.RequestOpOrBuilder> 
   ...
   * <code>repeated .etcdserverpb.RequestOp success = 2;</code>
   */
  public com.coreos.etcd3.api.RequestOp getSuccess(int index) {
   ...
   * <code>repeated .etcdserverpb.RequestOp success = 2;</code>
   */
  public com.coreos.etcd3.api.RequestOpOrBuilder getSuccessOrBuilder(
      int index) {
    return success_.get(index);
  }

  public static final int FAILURE_FIELD_NUMBER = 3;
  private java.util.List<com.coreos.etcd3.api.RequestOp> failure_;
  /**
   * <pre>
   ...
   */
  public java.util.List<com.coreos.etcd3.api.RequestOp> getFailureList() {
    return failure_;
  }
  /**
   * <pre>
   ...
   * <code>repeated .etcdserverpb.RequestOp failure = 3;</code>
   */
  public com.coreos.etcd3.api.RequestOp getFailure(int index) {
   ...
   * <code>repeated .etcdserverpb.RequestOp failure = 3;</code>
   */
  public com.coreos.etcd3.api.RequestOpOrBuilder getFailureOrBuilder(
      int index) {
    return failure_.get(index);
  }
  ...
  public boolean equals(final java.lang.Object obj) {
    ...
    if (!(obj instanceof com.coreos.etcd3.api.TxnRequest)) {
      return super.equals(obj);
    }
    com.coreos.etcd3.api.TxnRequest other = (com.coreos.etcd3.api.TxnRequest) obj;
  ...
  public static com.coreos.etcd3.api.TxnRequest parseFrom(
  ...
  public static com.coreos.etcd3.api.TxnRequest parseFrom(byte[] data)
      throws com.google.protobuf.InvalidProtocolBufferException {
    return PARSER.parseFrom(data);
  }
  public static com.coreos.etcd3.api.TxnRequest parseFrom(
  ...
  public static com.coreos.etcd3.api.TxnRequest parseFrom(java.io.InputStream input)
      throws java.io.IOException {
  ...
  public static com.coreos.etcd3.api.TxnRequest parseDelimitedFrom(java.io.InputStream input)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
        .parseDelimitedWithIOException(PARSER, input);
  }
  public static com.coreos.etcd3.api.TxnRequest parseDelimitedFrom(
      java.io.InputStream input,
      com.google.protobuf.ExtensionRegistryLite extensionRegistry)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
  ...
  public static Builder newBuilder(com.coreos.etcd3.api.TxnRequest prototype) {
  ...
  public static final class Builder extends
      ...
      com.coreos.etcd3.api.TxnRequestOrBuilder {
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return com.coreos.etcd3.api.Rpc.internal_static_etcdserverpb_TxnRequest_descriptor;
    }
    ...
    // Construct using com.coreos.etcd3.api.TxnRequest.newBuilder()
    private Builder() {
    ...
    public com.coreos.etcd3.api.TxnRequest getDefaultInstanceForType() {
      return com.coreos.etcd3.api.TxnRequest.getDefaultInstance();
    }

    public com.coreos.etcd3.api.TxnRequest build() {
      com.coreos.etcd3.api.TxnRequest result = buildPartial();
    ...
    public com.coreos.etcd3.api.TxnRequest buildPartial() {
      com.coreos.etcd3.api.TxnRequest result = new com.coreos.etcd3.api.TxnRequest(this);
    ...
    public Builder mergeFrom(com.google.protobuf.Message other) {
      if (other instanceof com.coreos.etcd3.api.TxnRequest) {
        return mergeFrom((com.coreos.etcd3.api.TxnRequest)other);
      } else {
    ...
    public Builder mergeFrom(com.coreos.etcd3.api.TxnRequest other) {
      if (other == com.coreos.etcd3.api.TxnRequest.getDefaultInstance()) return this;
      if (compareBuilder_ == null) {
    ...
    public Builder mergeFrom(
        ...
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      com.coreos.etcd3.api.TxnRequest parsedMessage = null;
      try {
        parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
      } catch (com.google.protobuf.InvalidProtocolBufferException e) {
        parsedMessage = (com.coreos.etcd3.api.TxnRequest) e.getUnfinishedMessage();
    ...
    private void ensureCompareIsMutable() {
      if (!((bitField0_ & 0x00000001) == 0x00000001)) {
        compare_ = new java.util.ArrayList<com.coreos.etcd3.api.Compare>(compare_);
        bitField0_ |= 0x00000001;
       }
    }

    private com.google.protobuf.RepeatedFieldBuilderV3<
        com.coreos.etcd3.api.Compare, com.coreos.etcd3.api.Compare.Builder, com.coreos.etcd3.api.CompareOrBuilder> compareBuilder_;
    ...
    public Builder setCompare(
        int index, com.coreos.etcd3.api.Compare value) {
      if (compareBuilder_ == null) {
        if (value == null) {
     ...
     */
    public Builder setCompare(
        int index, com.coreos.etcd3.api.Compare.Builder builderForValue) {
      if (compareBuilder_ == null) {
        ensureCompareIsMutable();
     ...
     * <code>repeated .etcdserverpb.Compare compare = 1;</code>
     */
    public Builder addCompare(com.coreos.etcd3.api.Compare value) {
      if (compareBuilder_ == null) {
        if (value == null) {
          throw new NullPointerException();
        }
     ...
     */
    public Builder addCompare(
        com.coreos.etcd3.api.Compare.Builder builderForValue) {
      if (compareBuilder_ == null) {
        ensureCompareIsMutable();
    ...
    public Builder addAllCompare(
        java.lang.Iterable<? extends com.coreos.etcd3.api.Compare> values) {
      if (compareBuilder_ == null) {
        ensureCompareIsMutable();
     ...
     * <code>repeated .etcdserverpb.Compare compare = 1;</code>
     */
    public com.coreos.etcd3.api.Compare.Builder getCompareBuilder(
        int index) {
     ...
     * <code>repeated .etcdserverpb.Compare compare = 1;</code>
     */
    public com.coreos.etcd3.api.Compare.Builder addCompareBuilder() {
      return getCompareFieldBuilder().addBuilder(
          com.coreos.etcd3.api.Compare.getDefaultInstance());
    }
    /**
     * <pre>
     * compare is a list of predicates representing a conjunction of terms.
    ...
    public com.coreos.etcd3.api.Compare.Builder addCompareBuilder(
        int index) {
      return getCompareFieldBuilder().addBuilder(
          index, com.coreos.etcd3.api.Compare.getDefaultInstance());
    }
    /**
     * <pre>
     * compare is a list of predicates representing a conjunction of terms.
     ...
     * <code>repeated .etcdserverpb.Compare compare = 1;</code>
     */
    public java.util.List<com.coreos.etcd3.api.Compare.Builder> 
         getCompareBuilderList() {
      return getCompareFieldBuilder().getBuilderList();
    }
    private com.google.protobuf.RepeatedFieldBuilderV3<
        com.coreos.etcd3.api.Compare, com.coreos.etcd3.api.Compare.Builder, com.coreos.etcd3.api.CompareOrBuilder> 
        getCompareFieldBuilder() {
      if (compareBuilder_ == null) {
    ...
    private void ensureSuccessIsMutable() {
      if (!((bitField0_ & 0x00000002) == 0x00000002)) {
        success_ = new java.util.ArrayList<com.coreos.etcd3.api.RequestOp>(success_);
        bitField0_ |= 0x00000002;
       }
    }

    private com.google.protobuf.RepeatedFieldBuilderV3<
        com.coreos.etcd3.api.RequestOp, com.coreos.etcd3.api.RequestOp.Builder, com.coreos.etcd3.api.RequestOpOrBuilder> successBuilder_;
    ...
    public Builder setSuccess(
        int index, com.coreos.etcd3.api.RequestOp value) {
      if (successBuilder_ == null) {
        if (value == null) {
          throw new NullPointerException();
        }
     ...
     */
    public Builder setSuccess(
        int index, com.coreos.etcd3.api.RequestOp.Builder builderForValue) {
      if (successBuilder_ == null) {
        ensureSuccessIsMutable();
     ...
     * <code>repeated .etcdserverpb.RequestOp success = 2;</code>
     */
    public Builder addSuccess(com.coreos.etcd3.api.RequestOp value) {
      if (successBuilder_ == null) {
        if (value == null) {
          throw new NullPointerException();
        }
     ...
     */
    public Builder addSuccess(
        com.coreos.etcd3.api.RequestOp.Builder builderForValue) {
      if (successBuilder_ == null) {
        ensureSuccessIsMutable();
    ...
    public Builder addAllSuccess(
        java.lang.Iterable<? extends com.coreos.etcd3.api.RequestOp> values) {
      if (successBuilder_ == null) {
        ensureSuccessIsMutable();
        com.google.protobuf.AbstractMessageLite.Builder.addAll(
            values, success_);
     ...
     * <code>repeated .etcdserverpb.RequestOp success = 2;</code>
     */
    public com.coreos.etcd3.api.RequestOp.Builder getSuccessBuilder(
        int index) {
     ...
     * <code>repeated .etcdserverpb.RequestOp success = 2;</code>
     */
    public com.coreos.etcd3.api.RequestOp.Builder addSuccessBuilder() {
      return getSuccessFieldBuilder().addBuilder(
          com.coreos.etcd3.api.RequestOp.getDefaultInstance());
    }
    /**
     * <pre>
     * success is a list of requests which will be applied when compare evaluates to true.
    ...
    public com.coreos.etcd3.api.RequestOp.Builder addSuccessBuilder(
        int index) {
      return getSuccessFieldBuilder().addBuilder(
          index, com.coreos.etcd3.api.RequestOp.getDefaultInstance());
    }
    /**
     * <pre>
     * success is a list of requests which will be applied when compare evaluates to true.
     ...
     * <code>repeated .etcdserverpb.RequestOp success = 2;</code>
     */
    public java.util.List<com.coreos.etcd3.api.RequestOp.Builder> 
         getSuccessBuilderList() {
      return getSuccessFieldBuilder().getBuilderList();
    }
    private com.google.protobuf.RepeatedFieldBuilderV3<
        com.coreos.etcd3.api.RequestOp, com.coreos.etcd3.api.RequestOp.Builder, com.coreos.etcd3.api.RequestOpOrBuilder> 
        getSuccessFieldBuilder() {
      if (successBuilder_ == null) {
    ...
    private void ensureFailureIsMutable() {
      if (!((bitField0_ & 0x00000004) == 0x00000004)) {
        failure_ = new java.util.ArrayList<com.coreos.etcd3.api.RequestOp>(failure_);
        bitField0_ |= 0x00000004;
       }
    }

    private com.google.protobuf.RepeatedFieldBuilderV3<
        com.coreos.etcd3.api.RequestOp, com.coreos.etcd3.api.RequestOp.Builder, com.coreos.etcd3.api.RequestOpOrBuilder> failureBuilder_;
     ...
     * <code>repeated .etcdserverpb.RequestOp failure = 3;</code>
     */
    public Builder addFailure(com.coreos.etcd3.api.RequestOp value) {
      if (failureBuilder_ == null) {
        if (value == null) {
          throw new NullPointerException();
        }
     ...
     * <code>repeated .etcdserverpb.RequestOp failure = 3;</code>
     */
    public com.coreos.etcd3.api.RequestOp.Builder getFailureBuilder(
        int index) {
     ...
     * <code>repeated .etcdserverpb.RequestOp failure = 3;</code>
     */
    public com.coreos.etcd3.api.RequestOp.Builder addFailureBuilder() {
  ...
  private static final com.coreos.etcd3.api.TxnRequest DEFAULT_INSTANCE;
  static {
    DEFAULT_INSTANCE = new com.coreos.etcd3.api.TxnRequest();
  }

  public static com.coreos.etcd3.api.TxnRequest getDefaultInstance() {
