...
public  final class DeleteRangeResponse extends
        ...
        switch (tag) {
          ...
          case 26: {
            if (!((mutable_bitField0_ & 0x00000004) == 0x00000004)) {
              prevKvs_ = new java.util.ArrayList<mvccpb.Kv.KeyValue>();
              mutable_bitField0_ |= 0x00000004;
            }
            prevKvs_.add(
                input.readMessage(mvccpb.Kv.KeyValue.parser(), extensionRegistry));
            break;
          }
        }
      }
  ...
  public static final com.google.protobuf.Descriptors.Descriptor
      getDescriptor() {
    return com.coreos.etcd3.api.Rpc.internal_static_etcdserverpb_DeleteRangeResponse_descriptor;
  }

  protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
      internalGetFieldAccessorTable() {
    return com.coreos.etcd3.api.Rpc.internal_static_etcdserverpb_DeleteRangeResponse_fieldAccessorTable
        .ensureFieldAccessorsInitialized(
            com.coreos.etcd3.api.DeleteRangeResponse.class, com.coreos.etcd3.api.DeleteRangeResponse.Builder.class);
  }
  ...
  private java.util.List<mvccpb.Kv.KeyValue> prevKvs_;
  /**
   * <pre>
   ...
   */
  public java.util.List<mvccpb.Kv.KeyValue> getPrevKvsList() {
    return prevKvs_;
  }
  /**
   * <pre>
   ...
   * <code>repeated .mvccpb.KeyValue prev_kvs = 3;</code>
   */
  public java.util.List<? extends mvccpb.Kv.KeyValueOrBuilder> 
   ...
   * <code>repeated .mvccpb.KeyValue prev_kvs = 3;</code>
   */
  public mvccpb.Kv.KeyValue getPrevKvs(int index) {
   ...
   * <code>repeated .mvccpb.KeyValue prev_kvs = 3;</code>
   */
  public mvccpb.Kv.KeyValueOrBuilder getPrevKvsOrBuilder(
      int index) {
    return prevKvs_.get(index);
  }
  ...
  public boolean equals(final java.lang.Object obj) {
    ...
    if (!(obj instanceof com.coreos.etcd3.api.DeleteRangeResponse)) {
      return super.equals(obj);
    }
    com.coreos.etcd3.api.DeleteRangeResponse other = (com.coreos.etcd3.api.DeleteRangeResponse) obj;
  ...
  public static com.coreos.etcd3.api.DeleteRangeResponse parseFrom(
  ...
  public static com.coreos.etcd3.api.DeleteRangeResponse parseFrom(byte[] data)
      throws com.google.protobuf.InvalidProtocolBufferException {
    return PARSER.parseFrom(data);
  }
  public static com.coreos.etcd3.api.DeleteRangeResponse parseFrom(
  ...
  public static com.coreos.etcd3.api.DeleteRangeResponse parseFrom(java.io.InputStream input)
      throws java.io.IOException {
  ...
  public static com.coreos.etcd3.api.DeleteRangeResponse parseDelimitedFrom(java.io.InputStream input)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
        .parseDelimitedWithIOException(PARSER, input);
  }
  public static com.coreos.etcd3.api.DeleteRangeResponse parseDelimitedFrom(
      java.io.InputStream input,
      com.google.protobuf.ExtensionRegistryLite extensionRegistry)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
  ...
  public static Builder newBuilder(com.coreos.etcd3.api.DeleteRangeResponse prototype) {
  ...
  public static final class Builder extends
      ...
      com.coreos.etcd3.api.DeleteRangeResponseOrBuilder {
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return com.coreos.etcd3.api.Rpc.internal_static_etcdserverpb_DeleteRangeResponse_descriptor;
    }
    ...
    // Construct using com.coreos.etcd3.api.DeleteRangeResponse.newBuilder()
    private Builder() {
    ...
    public com.coreos.etcd3.api.DeleteRangeResponse getDefaultInstanceForType() {
      return com.coreos.etcd3.api.DeleteRangeResponse.getDefaultInstance();
    }

    public com.coreos.etcd3.api.DeleteRangeResponse build() {
      com.coreos.etcd3.api.DeleteRangeResponse result = buildPartial();
    ...
    public com.coreos.etcd3.api.DeleteRangeResponse buildPartial() {
      com.coreos.etcd3.api.DeleteRangeResponse result = new com.coreos.etcd3.api.DeleteRangeResponse(this);
    ...
    public Builder mergeFrom(com.google.protobuf.Message other) {
      if (other instanceof com.coreos.etcd3.api.DeleteRangeResponse) {
        return mergeFrom((com.coreos.etcd3.api.DeleteRangeResponse)other);
      } else {
    ...
    public Builder mergeFrom(com.coreos.etcd3.api.DeleteRangeResponse other) {
      if (other == com.coreos.etcd3.api.DeleteRangeResponse.getDefaultInstance()) return this;
      if (other.hasHeader()) {
    ...
    public Builder mergeFrom(
        ...
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      com.coreos.etcd3.api.DeleteRangeResponse parsedMessage = null;
      try {
        parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
      } catch (com.google.protobuf.InvalidProtocolBufferException e) {
        parsedMessage = (com.coreos.etcd3.api.DeleteRangeResponse) e.getUnfinishedMessage();
    ...
    private void ensurePrevKvsIsMutable() {
      if (!((bitField0_ & 0x00000004) == 0x00000004)) {
        prevKvs_ = new java.util.ArrayList<mvccpb.Kv.KeyValue>(prevKvs_);
        bitField0_ |= 0x00000004;
       }
    }

    private com.google.protobuf.RepeatedFieldBuilderV3<
        mvccpb.Kv.KeyValue, mvccpb.Kv.KeyValue.Builder, mvccpb.Kv.KeyValueOrBuilder> prevKvsBuilder_;
    ...
    public Builder setPrevKvs(
        int index, mvccpb.Kv.KeyValue value) {
      if (prevKvsBuilder_ == null) {
        if (value == null) {
          throw new NullPointerException();
        }
     ...
     */
    public Builder setPrevKvs(
        int index, mvccpb.Kv.KeyValue.Builder builderForValue) {
      if (prevKvsBuilder_ == null) {
        ensurePrevKvsIsMutable();
     ...
     * <code>repeated .mvccpb.KeyValue prev_kvs = 3;</code>
     */
    public Builder addPrevKvs(mvccpb.Kv.KeyValue value) {
      if (prevKvsBuilder_ == null) {
        if (value == null) {
          throw new NullPointerException();
        }
    ...
    public Builder addAllPrevKvs(
        java.lang.Iterable<? extends mvccpb.Kv.KeyValue> values) {
      if (prevKvsBuilder_ == null) {
        ensurePrevKvsIsMutable();
     ...
     * <code>repeated .mvccpb.KeyValue prev_kvs = 3;</code>
     */
    public mvccpb.Kv.KeyValue.Builder getPrevKvsBuilder(
        int index) {
     ...
     * <code>repeated .mvccpb.KeyValue prev_kvs = 3;</code>
     */
    public mvccpb.Kv.KeyValue.Builder addPrevKvsBuilder() {
      return getPrevKvsFieldBuilder().addBuilder(
          mvccpb.Kv.KeyValue.getDefaultInstance());
    }
    /**
     * <pre>
     * if prev_kv is set in the request, the previous key-value pairs will be returned.
    ...
    public mvccpb.Kv.KeyValue.Builder addPrevKvsBuilder(
        int index) {
      return getPrevKvsFieldBuilder().addBuilder(
          index, mvccpb.Kv.KeyValue.getDefaultInstance());
    }
    /**
     * <pre>
     * if prev_kv is set in the request, the previous key-value pairs will be returned.
     ...
     * <code>repeated .mvccpb.KeyValue prev_kvs = 3;</code>
     */
    public java.util.List<mvccpb.Kv.KeyValue.Builder> 
  ...
  private static final com.coreos.etcd3.api.DeleteRangeResponse DEFAULT_INSTANCE;
  static {
    DEFAULT_INSTANCE = new com.coreos.etcd3.api.DeleteRangeResponse();
  }

  public static com.coreos.etcd3.api.DeleteRangeResponse getDefaultInstance() {
