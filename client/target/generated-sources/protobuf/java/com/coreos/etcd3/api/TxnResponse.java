...
public  final class TxnResponse extends
        ...
        switch (tag) {
          ...
          case 26: {
            if (!((mutable_bitField0_ & 0x00000004) == 0x00000004)) {
              responses_ = new java.util.ArrayList<com.coreos.etcd3.api.ResponseOp>();
              mutable_bitField0_ |= 0x00000004;
            }
            responses_.add(
                input.readMessage(com.coreos.etcd3.api.ResponseOp.parser(), extensionRegistry));
            break;
          }
        }
      }
  ...
  public static final com.google.protobuf.Descriptors.Descriptor
      getDescriptor() {
    return com.coreos.etcd3.api.Rpc.internal_static_etcdserverpb_TxnResponse_descriptor;
  }

  protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
      internalGetFieldAccessorTable() {
    return com.coreos.etcd3.api.Rpc.internal_static_etcdserverpb_TxnResponse_fieldAccessorTable
        .ensureFieldAccessorsInitialized(
            com.coreos.etcd3.api.TxnResponse.class, com.coreos.etcd3.api.TxnResponse.Builder.class);
  }
  ...
  private java.util.List<com.coreos.etcd3.api.ResponseOp> responses_;
  /**
   * <pre>
   ...
   */
  public java.util.List<com.coreos.etcd3.api.ResponseOp> getResponsesList() {
    return responses_;
  }
  /**
   * <pre>
   ...
   * <code>repeated .etcdserverpb.ResponseOp responses = 3;</code>
   */
  public java.util.List<? extends com.coreos.etcd3.api.ResponseOpOrBuilder> 
   ...
   * <code>repeated .etcdserverpb.ResponseOp responses = 3;</code>
   */
  public com.coreos.etcd3.api.ResponseOp getResponses(int index) {
   ...
   * <code>repeated .etcdserverpb.ResponseOp responses = 3;</code>
   */
  public com.coreos.etcd3.api.ResponseOpOrBuilder getResponsesOrBuilder(
      int index) {
    return responses_.get(index);
  }
  ...
  public boolean equals(final java.lang.Object obj) {
    ...
    if (!(obj instanceof com.coreos.etcd3.api.TxnResponse)) {
      return super.equals(obj);
    }
    com.coreos.etcd3.api.TxnResponse other = (com.coreos.etcd3.api.TxnResponse) obj;
  ...
  public static com.coreos.etcd3.api.TxnResponse parseFrom(
  ...
  public static com.coreos.etcd3.api.TxnResponse parseFrom(byte[] data)
      throws com.google.protobuf.InvalidProtocolBufferException {
    return PARSER.parseFrom(data);
  }
  public static com.coreos.etcd3.api.TxnResponse parseFrom(
  ...
  public static com.coreos.etcd3.api.TxnResponse parseFrom(java.io.InputStream input)
      throws java.io.IOException {
  ...
  public static com.coreos.etcd3.api.TxnResponse parseDelimitedFrom(java.io.InputStream input)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
        .parseDelimitedWithIOException(PARSER, input);
  }
  public static com.coreos.etcd3.api.TxnResponse parseDelimitedFrom(
      java.io.InputStream input,
      com.google.protobuf.ExtensionRegistryLite extensionRegistry)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
  ...
  public static Builder newBuilder(com.coreos.etcd3.api.TxnResponse prototype) {
  ...
  public static final class Builder extends
      ...
      com.coreos.etcd3.api.TxnResponseOrBuilder {
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return com.coreos.etcd3.api.Rpc.internal_static_etcdserverpb_TxnResponse_descriptor;
    }
    ...
    // Construct using com.coreos.etcd3.api.TxnResponse.newBuilder()
    private Builder() {
    ...
    public com.coreos.etcd3.api.TxnResponse getDefaultInstanceForType() {
      return com.coreos.etcd3.api.TxnResponse.getDefaultInstance();
    }

    public com.coreos.etcd3.api.TxnResponse build() {
      com.coreos.etcd3.api.TxnResponse result = buildPartial();
    ...
    public com.coreos.etcd3.api.TxnResponse buildPartial() {
      com.coreos.etcd3.api.TxnResponse result = new com.coreos.etcd3.api.TxnResponse(this);
    ...
    public Builder mergeFrom(com.google.protobuf.Message other) {
      if (other instanceof com.coreos.etcd3.api.TxnResponse) {
        return mergeFrom((com.coreos.etcd3.api.TxnResponse)other);
      } else {
    ...
    public Builder mergeFrom(com.coreos.etcd3.api.TxnResponse other) {
      if (other == com.coreos.etcd3.api.TxnResponse.getDefaultInstance()) return this;
      if (other.hasHeader()) {
    ...
    public Builder mergeFrom(
        ...
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      com.coreos.etcd3.api.TxnResponse parsedMessage = null;
      try {
        parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
      } catch (com.google.protobuf.InvalidProtocolBufferException e) {
        parsedMessage = (com.coreos.etcd3.api.TxnResponse) e.getUnfinishedMessage();
    ...
    private void ensureResponsesIsMutable() {
      if (!((bitField0_ & 0x00000004) == 0x00000004)) {
        responses_ = new java.util.ArrayList<com.coreos.etcd3.api.ResponseOp>(responses_);
        bitField0_ |= 0x00000004;
       }
    }

    private com.google.protobuf.RepeatedFieldBuilderV3<
        com.coreos.etcd3.api.ResponseOp, com.coreos.etcd3.api.ResponseOp.Builder, com.coreos.etcd3.api.ResponseOpOrBuilder> responsesBuilder_;
    ...
    public Builder setResponses(
        int index, com.coreos.etcd3.api.ResponseOp value) {
      if (responsesBuilder_ == null) {
        if (value == null) {
          throw new NullPointerException();
        }
     ...
     */
    public Builder setResponses(
        int index, com.coreos.etcd3.api.ResponseOp.Builder builderForValue) {
      if (responsesBuilder_ == null) {
        ensureResponsesIsMutable();
     ...
     * <code>repeated .etcdserverpb.ResponseOp responses = 3;</code>
     */
    public Builder addResponses(com.coreos.etcd3.api.ResponseOp value) {
      if (responsesBuilder_ == null) {
        if (value == null) {
          throw new NullPointerException();
        }
     ...
     */
    public Builder addResponses(
        com.coreos.etcd3.api.ResponseOp.Builder builderForValue) {
      if (responsesBuilder_ == null) {
        ensureResponsesIsMutable();
    ...
    public Builder addAllResponses(
        java.lang.Iterable<? extends com.coreos.etcd3.api.ResponseOp> values) {
      if (responsesBuilder_ == null) {
        ensureResponsesIsMutable();
     ...
     * <code>repeated .etcdserverpb.ResponseOp responses = 3;</code>
     */
    public com.coreos.etcd3.api.ResponseOp.Builder getResponsesBuilder(
        int index) {
     ...
     * <code>repeated .etcdserverpb.ResponseOp responses = 3;</code>
     */
    public com.coreos.etcd3.api.ResponseOp.Builder addResponsesBuilder() {
      return getResponsesFieldBuilder().addBuilder(
          com.coreos.etcd3.api.ResponseOp.getDefaultInstance());
    }
    /**
     * <pre>
     * responses is a list of responses corresponding to the results from applying
    ...
    public com.coreos.etcd3.api.ResponseOp.Builder addResponsesBuilder(
        int index) {
      return getResponsesFieldBuilder().addBuilder(
          index, com.coreos.etcd3.api.ResponseOp.getDefaultInstance());
    }
    /**
     * <pre>
     * responses is a list of responses corresponding to the results from applying
     ...
     * <code>repeated .etcdserverpb.ResponseOp responses = 3;</code>
     */
    public java.util.List<com.coreos.etcd3.api.ResponseOp.Builder> 
         getResponsesBuilderList() {
      return getResponsesFieldBuilder().getBuilderList();
    }
    private com.google.protobuf.RepeatedFieldBuilderV3<
        com.coreos.etcd3.api.ResponseOp, com.coreos.etcd3.api.ResponseOp.Builder, com.coreos.etcd3.api.ResponseOpOrBuilder> 
        getResponsesFieldBuilder() {
      if (responsesBuilder_ == null) {
  ...
  private static final com.coreos.etcd3.api.TxnResponse DEFAULT_INSTANCE;
  static {
    DEFAULT_INSTANCE = new com.coreos.etcd3.api.TxnResponse();
  }

  public static com.coreos.etcd3.api.TxnResponse getDefaultInstance() {
