...
public  final class AlarmResponse extends
        ...
        switch (tag) {
          ...
          case 18: {
            if (!((mutable_bitField0_ & 0x00000002) == 0x00000002)) {
              alarms_ = new java.util.ArrayList<com.coreos.etcd3.api.AlarmMember>();
              mutable_bitField0_ |= 0x00000002;
            }
            alarms_.add(
                input.readMessage(com.coreos.etcd3.api.AlarmMember.parser(), extensionRegistry));
            break;
          }
        }
      }
  ...
  public static final com.google.protobuf.Descriptors.Descriptor
      getDescriptor() {
    return com.coreos.etcd3.api.Rpc.internal_static_etcdserverpb_AlarmResponse_descriptor;
  }

  protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
      internalGetFieldAccessorTable() {
    return com.coreos.etcd3.api.Rpc.internal_static_etcdserverpb_AlarmResponse_fieldAccessorTable
        .ensureFieldAccessorsInitialized(
            com.coreos.etcd3.api.AlarmResponse.class, com.coreos.etcd3.api.AlarmResponse.Builder.class);
  }
  ...
  private java.util.List<com.coreos.etcd3.api.AlarmMember> alarms_;
  /**
   * <pre>
   ...
   */
  public java.util.List<com.coreos.etcd3.api.AlarmMember> getAlarmsList() {
    return alarms_;
  }
  /**
   * <pre>
   ...
   * <code>repeated .etcdserverpb.AlarmMember alarms = 2;</code>
   */
  public java.util.List<? extends com.coreos.etcd3.api.AlarmMemberOrBuilder> 
   ...
   * <code>repeated .etcdserverpb.AlarmMember alarms = 2;</code>
   */
  public com.coreos.etcd3.api.AlarmMember getAlarms(int index) {
   ...
   * <code>repeated .etcdserverpb.AlarmMember alarms = 2;</code>
   */
  public com.coreos.etcd3.api.AlarmMemberOrBuilder getAlarmsOrBuilder(
      int index) {
    return alarms_.get(index);
  }
  ...
  public boolean equals(final java.lang.Object obj) {
    ...
    if (!(obj instanceof com.coreos.etcd3.api.AlarmResponse)) {
      return super.equals(obj);
    }
    com.coreos.etcd3.api.AlarmResponse other = (com.coreos.etcd3.api.AlarmResponse) obj;
  ...
  public static com.coreos.etcd3.api.AlarmResponse parseFrom(
  ...
  public static com.coreos.etcd3.api.AlarmResponse parseFrom(byte[] data)
      throws com.google.protobuf.InvalidProtocolBufferException {
    return PARSER.parseFrom(data);
  }
  public static com.coreos.etcd3.api.AlarmResponse parseFrom(
  ...
  public static com.coreos.etcd3.api.AlarmResponse parseFrom(java.io.InputStream input)
      throws java.io.IOException {
  ...
  public static com.coreos.etcd3.api.AlarmResponse parseDelimitedFrom(java.io.InputStream input)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
        .parseDelimitedWithIOException(PARSER, input);
  }
  public static com.coreos.etcd3.api.AlarmResponse parseDelimitedFrom(
      java.io.InputStream input,
      com.google.protobuf.ExtensionRegistryLite extensionRegistry)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
  ...
  public static Builder newBuilder(com.coreos.etcd3.api.AlarmResponse prototype) {
  ...
  public static final class Builder extends
      ...
      com.coreos.etcd3.api.AlarmResponseOrBuilder {
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return com.coreos.etcd3.api.Rpc.internal_static_etcdserverpb_AlarmResponse_descriptor;
    }
    ...
    // Construct using com.coreos.etcd3.api.AlarmResponse.newBuilder()
    private Builder() {
    ...
    public com.coreos.etcd3.api.AlarmResponse getDefaultInstanceForType() {
      return com.coreos.etcd3.api.AlarmResponse.getDefaultInstance();
    }

    public com.coreos.etcd3.api.AlarmResponse build() {
      com.coreos.etcd3.api.AlarmResponse result = buildPartial();
    ...
    public com.coreos.etcd3.api.AlarmResponse buildPartial() {
      com.coreos.etcd3.api.AlarmResponse result = new com.coreos.etcd3.api.AlarmResponse(this);
    ...
    public Builder mergeFrom(com.google.protobuf.Message other) {
      if (other instanceof com.coreos.etcd3.api.AlarmResponse) {
        return mergeFrom((com.coreos.etcd3.api.AlarmResponse)other);
      } else {
    ...
    public Builder mergeFrom(com.coreos.etcd3.api.AlarmResponse other) {
      if (other == com.coreos.etcd3.api.AlarmResponse.getDefaultInstance()) return this;
      if (other.hasHeader()) {
    ...
    public Builder mergeFrom(
        ...
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      com.coreos.etcd3.api.AlarmResponse parsedMessage = null;
      try {
        parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
      } catch (com.google.protobuf.InvalidProtocolBufferException e) {
        parsedMessage = (com.coreos.etcd3.api.AlarmResponse) e.getUnfinishedMessage();
    ...
    private void ensureAlarmsIsMutable() {
      if (!((bitField0_ & 0x00000002) == 0x00000002)) {
        alarms_ = new java.util.ArrayList<com.coreos.etcd3.api.AlarmMember>(alarms_);
        bitField0_ |= 0x00000002;
       }
    }

    private com.google.protobuf.RepeatedFieldBuilderV3<
        com.coreos.etcd3.api.AlarmMember, com.coreos.etcd3.api.AlarmMember.Builder, com.coreos.etcd3.api.AlarmMemberOrBuilder> alarmsBuilder_;
    ...
    public Builder setAlarms(
        int index, com.coreos.etcd3.api.AlarmMember value) {
      if (alarmsBuilder_ == null) {
        if (value == null) {
          throw new NullPointerException();
        }
     ...
     */
    public Builder setAlarms(
        int index, com.coreos.etcd3.api.AlarmMember.Builder builderForValue) {
      if (alarmsBuilder_ == null) {
        ensureAlarmsIsMutable();
     ...
     * <code>repeated .etcdserverpb.AlarmMember alarms = 2;</code>
     */
    public Builder addAlarms(com.coreos.etcd3.api.AlarmMember value) {
      if (alarmsBuilder_ == null) {
        if (value == null) {
          throw new NullPointerException();
        }
     ...
     */
    public Builder addAlarms(
        com.coreos.etcd3.api.AlarmMember.Builder builderForValue) {
      if (alarmsBuilder_ == null) {
        ensureAlarmsIsMutable();
    ...
    public Builder addAllAlarms(
        java.lang.Iterable<? extends com.coreos.etcd3.api.AlarmMember> values) {
      if (alarmsBuilder_ == null) {
        ensureAlarmsIsMutable();
     ...
     * <code>repeated .etcdserverpb.AlarmMember alarms = 2;</code>
     */
    public com.coreos.etcd3.api.AlarmMember.Builder getAlarmsBuilder(
        int index) {
     ...
     * <code>repeated .etcdserverpb.AlarmMember alarms = 2;</code>
     */
    public com.coreos.etcd3.api.AlarmMember.Builder addAlarmsBuilder() {
      return getAlarmsFieldBuilder().addBuilder(
          com.coreos.etcd3.api.AlarmMember.getDefaultInstance());
    }
    /**
     * <pre>
     * alarms is a list of alarms associated with the alarm request.
    ...
    public com.coreos.etcd3.api.AlarmMember.Builder addAlarmsBuilder(
        int index) {
      return getAlarmsFieldBuilder().addBuilder(
          index, com.coreos.etcd3.api.AlarmMember.getDefaultInstance());
    }
    /**
     * <pre>
     * alarms is a list of alarms associated with the alarm request.
     ...
     * <code>repeated .etcdserverpb.AlarmMember alarms = 2;</code>
     */
    public java.util.List<com.coreos.etcd3.api.AlarmMember.Builder> 
         getAlarmsBuilderList() {
      return getAlarmsFieldBuilder().getBuilderList();
    }
    private com.google.protobuf.RepeatedFieldBuilderV3<
        com.coreos.etcd3.api.AlarmMember, com.coreos.etcd3.api.AlarmMember.Builder, com.coreos.etcd3.api.AlarmMemberOrBuilder> 
        getAlarmsFieldBuilder() {
      if (alarmsBuilder_ == null) {
  ...
  private static final com.coreos.etcd3.api.AlarmResponse DEFAULT_INSTANCE;
  static {
    DEFAULT_INSTANCE = new com.coreos.etcd3.api.AlarmResponse();
  }

  public static com.coreos.etcd3.api.AlarmResponse getDefaultInstance() {
